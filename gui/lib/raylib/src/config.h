...
// LOCAL PATCH: the world is built at _gridSize = 0.01, so the stock near plane of
// 0.05 would clip it entirely and the 4000.0 far plane wrecks depth precision.
